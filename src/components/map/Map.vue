...
export default {
    ...
    methods: {
        ...
        addMarkerList() {
            this.markerList = []
            this.infoWindows = []
            this.rawCultures.forEach(({ TITLE: title, CODENAME: codeName, DATE: date, IS_FREE: isFree, USE_FEE: useFee, LOT: lat, LAT: lng }, index) => {
                ...
                window.naver.maps.Event.addListener(this.markerList[index], 'click', () => this.onClickMarker(index))
            })
